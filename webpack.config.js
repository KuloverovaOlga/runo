...
const entryPoints = {
    ...
    detailed_page: path.resolve(__dirname, 'src', 'index.js'),
    services: path.resolve(__dirname, 'src', 'index.js'),
    detailed_services_measurement: path.resolve(__dirname, 'src', 'index.js'),
    detailed_services_installation: path.resolve(__dirname, 'src', 'index.js'),
    detailed_services_repair: path.resolve(__dirname, 'src', 'index.js'),
    our_works: path.resolve(__dirname, 'src', 'index.js'),
    about: path.resolve(__dirname, 'src', 'index.js'),
    questions: path.resolve(__dirname, 'src', 'index.js'),
